...
class WajibTab extends StatelessWidget {
  final List<Map<String, dynamic>> puasaWajib;
  final Function(Map<String, dynamic>) onPuasaTap;

  const WajibTab({
    super.key,
    required this.puasaWajib,
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.builder(
      ...
      itemCount: puasaWajib.length,
      itemBuilder: (context, index) {
        final puasa = puasaWajib[index];
